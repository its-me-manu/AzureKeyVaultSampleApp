...
/// <summary>
///     This file was taken from the Renci.SshNet.Async project.
///     https://github.com/JohnTheGr8/Renci.SshNet.Async
///     The NuGet package isn't compatible with the current version of SSH.NET. But all there is to it is this single class.
/// </summary>
public static class SshNetAsyncExtensions
{
    /// <summary>
    ...
    ///     The <see cref="System.Threading.Tasks.TaskScheduler">TaskScheduler</see>
